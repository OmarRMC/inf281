                    ...
                    <Accordion key={dats.id_donacion} className={style.containerAcor}>
                        ...
                        <Typography>Nro. de donación: {dats.id_donacion}</Typography>
                            ...
                            <AccordionDetails>
                                ...
                                <TableRD columns={createDataRD} rows={dats.postulantes} idDon={dats.id_donacion} setAct={setAct} Act={Act} ruta={'https://proyecto-281-production.up.railway.app/api/donation/confirmarResponsableDonacion'}/>
                            </AccordionDetails>
                    </Accordion>
                ))
